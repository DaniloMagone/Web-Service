...
for link in link_list:
  ...
  for post in posts:
    ...
    for var in [dia,mes,ano] :
      #caso não haja dois campos de dias/meses/anos, então considera-se que o dia, mês ou ano
      # são os mesmos que os iniciais.
      if len(var) == 1 : var *= 2
...
#Os eventos recorrentes são identificados pela semelhança entre os títulos
# descartando pontuação, caractéres especiais, números romanos e espaços.
# A semelhança é calculada utilizando o pacote Levenshtein juntamente com o FuzzyWuzzy
